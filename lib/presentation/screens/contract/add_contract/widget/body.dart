...
class AddContractBody extends StatefulWidget {
  const AddContractBody({super.key});

  @override
  State<AddContractBody> createState() => _AddContractBodyState();
}

class _AddContractBodyState extends State<AddContractBody> {
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text(
            translateString("A copy of the lease contract", "صوره عقد الايجار"),
            style: headingStyle2(
              context: context,
              color: colorBlack,
            ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        translateString("Add A copy of the lease contract",
                            "اضف صوره عقد الايجار"),
                        style: bodyStryle(
                          context: context,
                          color: colorGrey,
                        ),
